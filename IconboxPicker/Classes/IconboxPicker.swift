...
public class IconboxPicker {
    ...
    fileprivate func createPayload(keyword: String, scheme: String? = nil) throws -> (String?, Data?) {
        if let name = (Bundle.main.infoDictionary!["CFBundleDisplayName"] as? String) ?? (Bundle.main.infoDictionary!["CFBundleName"] as? String), let identifier = Bundle.main.infoDictionary![kCFBundleIdentifierKey as String] as? String {
